...
def get_kline_minute(col_dict, log_obj):
    table_name = "kline_minute_sol"
    ...
    while judage_loop:
        ...
        time_se = pd.date_range(start=sol_begin_time, periods=1900, freq="15min").to_series()
        ...
        name, data = get_kline("gate-io_SOL_USDT", sol_begin_int, sol_end_int, "15m")
