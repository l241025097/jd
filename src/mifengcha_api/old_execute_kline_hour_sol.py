...
def get_kline_hour(col_dict, log_obj):
    table_name = "kline_hour_sol"
    ...
    while judage_loop:
        ...
        time_se = pd.date_range(start=sol_begin_time, periods=1993, freq="h").to_series()
        ...
        name, data = get_kline("gate-io_SOL_USDT", sol_begin_int, sol_end_int, "1h")
...
def execute():
    ...
    get_kline_hour(col_dict, log_obj)
